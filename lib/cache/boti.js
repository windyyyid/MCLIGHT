...
process.on("unhandledRejection", errorHandler);
 ...
 if (process.argv.length < 7){console.log(`Usage: node boti.js target time rate thread proxy.txt`); process.exit();}
 const headers = {};
...
const tips1 =[
 "Use Proxy Premium Pv @xyzuxyzo",
 "Buy Method? @xyzuxyzo",
 "Proxy high easy take down website",
 "XYZU Created in 2024, Friends Who Supported me: @xyzuxyzo"
];
